...
import { getLinks, getNEPToken } from "@/lib/connect-wallet/config/stats";
import { amountFormatter } from "@/lib/connect-wallet/utils/formatter";
import { convertFromUnits } from "@/lib/connect-wallet/utils/bignumbers";
import { truncateAddress } from "@/lib/connect-wallet/utils/address";
import { useStatsContext } from "src/hooks/useStatsContext";
