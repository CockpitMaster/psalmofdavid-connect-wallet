    ...
    if (!(window.web3 || window.ethereum)) {
      return (
        <a
          ...
          className="inline-flex w-full text-sm mb-5 font-normal text-black-900 bg-white border border-[#D4DFEE] rounded-lg focus:border-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
        >
