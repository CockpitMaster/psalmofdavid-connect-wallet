import { getDiscoveryContractInfo } from "@/lib/connect-wallet/config/stats";
import { convertToUnits } from "@/lib/connect-wallet/utils/bignumbers";
import { unixTimeAfter } from "@/lib/connect-wallet/utils/date";
...
const useDiscoveryContractInfo = () => {
